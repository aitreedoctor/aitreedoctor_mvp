...
function loadHistoryTable() {
    ...
    history.forEach(item => {
        ...
        if (appSettings.userRole === "doctor") {
            if (item.pdf_url) {
                pdfBtn = `
                    <a href="${BACKEND_URL}${item.pdf_url}?t=${new Date().getTime()}" target="_blank" class="btn-card-action" style="text-decoration:none; display:inline-flex; align-items:center; justify-content:center;"><i class="fa-solid fa-file-pdf"></i> PDF 받기</a>
